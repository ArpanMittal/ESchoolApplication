...
public class QuestionList implements Serializable {
    ...
    public QuestionList(String id,String hash,String type_id,String solution_path,String difficulty,String question_path,String answer,List<ChapterList> chapterLists)
    {
       this.id=id;
        this.hash=hash;
