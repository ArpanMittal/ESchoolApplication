    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Content - Class {!! isset($selected)?$selected->class_name:"NULL" !!}</div>
                    ...
                    <div class="widget-body">
                        <div id="dt_example" class="example_alt_pagination">
                            <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                                ...
                                @if(isset($content_class_subject_list))
                                    @foreach($content_class_subject_list as $class)
                                    <tr class="gradeA info">
                                        ...
                                        <td style="text-align:center">
                                            <a href="{{ url('/content/list/chapter/'.$class->id) }}" title='Preview'  data-icon="&#xe02f;"  data-original-title="Preview">
