    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">Content - Class {!! isset($selected)?$selected->class_name." - ".$selected->subject_name:"NULL" !!}</div>
                        ...
                        <div id="dt_example" class="example_alt_pagination">
                            <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                                ...
                                <tr  class="gradeA success">
                                    ...
                                    <th style="text-align:center">Stream - Chapter</th>
                                ...
                                @if(isset($content_cl_su_st_ch_list))
                                    @foreach($content_cl_su_st_ch_list as $chapter)
                                    <tr class="gradeA info">
                                        <td style="text-align:right;width:60px">{{isset($Sno)?++$Sno:$Sno=1}}</td>
                                        <td style="width:60px">{{$chapter->stream_name}} - {{$chapter->name}}</td>
                                        <td style="text-align:left">{{$chapter->summery}}</td>
                                        <td style="text-align:center">
                                            <a href="{{ url('/content/add/'.$chapter->id) }}" title='Preview'  data-icon="&#xe02f;"  data-original-title="Preview">
